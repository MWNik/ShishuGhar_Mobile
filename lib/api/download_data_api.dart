...
class DownloadDataApi {
  ...
  Future<Response> callVillageFilterDataApi(String villageId,String username, String pwd, String token) async {
    var url = Uri.parse(
        '${Constants.baseUrl}method/hh_village_filter');
  ...
  Future<Response> callVillagesDataDownload(String villageId,String username, String pwd, String token) async {
    var url = Uri.parse(
        '${Constants.baseUrl}method/hh_mvillage_filter');
