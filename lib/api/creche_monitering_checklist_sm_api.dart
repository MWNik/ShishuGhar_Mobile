...
class CrecheMonetringCheckListSMApi {
  Future<Response> smCheckListMetaApi(
      String username, String pwd, String token) async {
    var url = Uri.parse(
        '${Constants.baseUrl}method/safety_indicators_meta');
  ...
  Future<Response> cmcSMDownloadApi(
      String username, String pwd, String token) async {
    var url = Uri.parse(
        '${Constants.baseUrl}method/safety_data_download');
    var headers = {'Authorization': token};
    Map<String, String> parameters = {
      'usr': username,
      'pwd': pwd,
  ...
  Future<http.Response> cmcSMUpload(String token, String responce) async {
    var url = Uri.parse(
        '${Constants.baseUrl}resource/Safety Indicators');
  ...
  Future<http.Response> cmcSMUploadUdate(
      String token, String responce, int? name) async {
    var url = Uri.parse(
        '${Constants.baseUrl}resource/Safety Indicators/$name');
    var headers = {'Authorization': token};
