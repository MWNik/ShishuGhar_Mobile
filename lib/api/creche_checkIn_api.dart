...
class CrecheCheckInApi {
  ...
  Future<http.Response> checkInMeta(String username, String pwd,String token) async {
  ...
  Future<http.Response> callDownloadCreCheCheckINApi(String username, String pwd, String token) async {
    var url = Uri.parse(
        '${Constants.baseUrl}method/checkin_data');
    var headers = {'Authorization': token};
