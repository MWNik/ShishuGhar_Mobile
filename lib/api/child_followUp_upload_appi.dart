...
class ChildFollowUpUploadApi {
  Future<http.Response> childFollowUpUpload(
      String token, String responce) async {
    var url = Uri.parse('${Constants.baseUrl}resource/Child Follow up');
  ...
  Future<http.Response> childFollowUpUploadUpdate(
      String token, String responce, int? name) async {
    var url = Uri.parse('${Constants.baseUrl}resource/Child Follow up/$name');
    var headers = {'Authorization': token};
