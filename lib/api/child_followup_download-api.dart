...
class ChildFollowUpDataDownloadApi {
  Future<Response> childFollowUpDataDownload(
      String username, String pwd, String token) async {
    var url =
        Uri.parse('${Constants.baseUrl}method/child_followup_data_download');
  ...
  Future<Response> childFollowUpDataDownloadCC(
      String villageId,String username, String pwd, String token) async {
    var url =
        Uri.parse('${Constants.baseUrl}method/child_followup_data_download_village');
