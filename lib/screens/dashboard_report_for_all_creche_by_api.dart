...
class DashboardReportSupeByApiScreen extends StatefulWidget {
  const DashboardReportSupeByApiScreen({
    super.key,
  });
...
class _DashboardReportSupeByApiState
    extends State<DashboardReportSupeByApiScreen> {
  List items = [];
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: CustomAppbar(
          text:
              Global.returnTrLable(translats, CustomText.DashBoardReport, lng),
          onTap: () {
            Navigator.pop(context, 'itemRefresh');
          },
        ),
                            ...
                            onTap: () async {
                              if (selectedMonth == null) {
                                Validate().singleButtonPopup(
                                    ...
                                    false,
                                    context);
                              } else if (items[index]['query_status'] != null) {
