    ...
    return Scaffold(
      body: Padding(
          ...
          child:
                Column(
              children:[
                  (receiptData.length>0)?ListView.builder(
          itemCount: receiptData.length,
              ...
              itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                    onTap: () async {
                      if(Global.getItemValues(receiptData[index].responces!, 'status')!="1"){
                        await callUpdateStatus(receiptData[index].responces!,receiptData[index].name!);
                      }
                    },
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          Column(
                            ...
                            scale: 4.5,
                            color: Global.getItemValues(receiptData[index].responces!, 'status')=='1'?
                            Color(0xff369A8D):Global.getItemValues(receiptData[index].responces!, 'status')=='2'?Color(0xffF26BA3):Colors.grey),
                                SizedBox(height: 5),
                                 (receiptData[index].is_edited==0 && receiptData[index].is_uploaded==1)?
                               Image.asset(
                                 "assets/sync.png",
                                 scale: 1.5,
                               ):
                ...
                child: Center(child: Text(Global.returnTrLable(
