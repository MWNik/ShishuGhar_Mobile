...
class CashbookExpensesDetailsViewScreen extends StatefulWidget {
  ...
  @override
  State<CashbookExpensesDetailsViewScreen> createState() =>
      _CashbookExpensesDetailsViewScreenState();
}

class _CashbookExpensesDetailsViewScreenState
    extends State<CashbookExpensesDetailsViewScreen> {
        ...
        if (element.fieldname == 'expense_amount' &&
          ...
          Validate().singleButtonPopup(
              Global.returnTrLable(
                  translats,
                  "Please enter amount less than or equal ₹${widget.reqAmount}",
                  lng!),
              Global.returnTrLable(translats, CustomText.ok, lng!),
              false,
              context);
