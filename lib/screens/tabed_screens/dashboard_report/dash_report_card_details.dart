...
class DashReportCardDetailScreen extends StatefulWidget {
  final String title;
...
class _DashReportCardDetailState extends State<DashReportCardDetailScreen> {
  List items = [];
  List growthChild = [];
  ...
  Widget widgetType(Map<String, dynamic> item) {
    ...
    } else if (widget.query_type == 'SeverelyWasted'||
