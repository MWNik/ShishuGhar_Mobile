...
class _DashReportState extends State<DashReport> {
  ...
  initItems() {
    ...
    cardItems['Growthfaltering1Plush'] = {
      'title':
      Global.returnTrLable(translats, CustomText.Growthfaltering1P, lng),
      'subtitle': '',
      'count': 0,
    };
    cardItems['zagZag'] = {
      'title':
      Global.returnTrLable(translats, CustomText.ZigZagPattern, lng),
      'subtitle': '',
      'count': 0,
    };
    cardItems['SNC'] = {
      'title': Global.returnTrLable(translats, CustomText.SNC, lng),
      'subtitle': '',
      'count': 0,
    };
    setState(() {});
  ...
  async {
    ...
    var gf1P = await DashboardReportHelper().excuteGF1PMeasurementTakenAllAnthro(
        stateId: stateId,
        districtId: districtId,
        blockId: blockId,
        gpId: gpId,
        ...
        childrenMeasurementTaken: childrenMeasurementTaken,
        allAntroData: allAntroData);
    if (cardItems.containsKey('Growthfaltering1Plush')) {
      cardItems['Growthfaltering1Plush'] = {
        'title':
        Global.returnTrLable(translats, CustomText.Growthfaltering1P, lng),
        'subtitle': '',
    ...
    var zigZag = await DashboardReportHelper().excuteZigZagMeasurementTakenAllAnthro(
        stateId: stateId,
        districtId: districtId,
        blockId: blockId,
        gpId: gpId,
        ...
        childrenMeasurementTaken: childrenMeasurementTaken,
        allAntroData: allAntroData);
    if (cardItems.containsKey('zagZag')) {
      cardItems['zagZag'] = {
        'title':
        Global.returnTrLable(translats, CustomText.ZigZagPattern, lng),
        'subtitle': '',
    ...
    var sncPattren = await DashboardReportHelper().excuteSNCPatternMeasurementTakenAllAnthro(
        stateId: stateId,
        districtId: districtId,
        blockId: blockId,
        gpId: gpId,
        ...
        childrenMeasurementTaken: childrenMeasurementTaken,
        allAntroData: allAntroData);
    if (cardItems.containsKey('SNC')) {
      cardItems['SNC'] = {
        'title':
        Global.returnTrLable(translats, CustomText.SNC, lng),
        'subtitle': '',
        'count': sncPattren.length,
        'isProgress': false
      };
      setState(() {});
    }
