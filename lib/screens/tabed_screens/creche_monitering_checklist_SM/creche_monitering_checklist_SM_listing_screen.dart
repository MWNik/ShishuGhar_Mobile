...
import 'creche_monitering_checklist_SM_tab_screen.dart';

class cmcSMListingScreen extends StatefulWidget {
  ...
  @override
  State<cmcSMListingScreen> createState() => _cmcSMListingScreenState();
}

class _cmcSMListingScreenState extends State<cmcSMListingScreen> {
  List<CmcSMResponseModel> cmcCCData = [];
  List<CmcSMResponseModel> filterCCdata = [];
  List<CmcSMResponseModel> usynchedList = [];
  ...
  Future<void> fetchCmcCCRecords() async {
    cmcCCData = await CmcSMTabResponseHelper()
          ...
          onTap: () async {
            ...
            if (!(Global.validString(ccGuid))) {
              ...
              var refStatus = await Navigator.of(context).push(MaterialPageRoute(
                  builder: (BuildContext context) => CmcSMTabSCreen(
                        cmc_cc_guid: ccGuid,
                  ...
                  ? ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                          onTap: () async {
                            var ccGuid = filterCCdata[index].smguid;
                            if (Global.validString(ccGuid)) {
