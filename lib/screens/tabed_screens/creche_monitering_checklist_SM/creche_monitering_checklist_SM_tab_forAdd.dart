...
import 'creche_monitering_checklist_SM_tabItem_view_forAdd.dart';
import 'creche_monitering_checklist_SM_tab_items_forAdd.dart';

class CmcSMTabSCreenForAdd extends StatefulWidget {
  ...
  @override
  State<CmcSMTabSCreenForAdd> createState() => _CmcSMTabSCreenForAddState();
}

class _CmcSMTabSCreenForAddState extends State<CmcSMTabSCreenForAdd>
  ...
  List<Widget> tabControllerScreen() {
    ...
    for (int i = 0; i < tabBreakItems.length; i++) {
      if (tabBreakItems[i].parent == 'Safety Indicators') {
  ...
  Future<bool> checkConditionsBeforeChangingTab(int index) async {
    ...
    var alredRecord = await CmcSMTabResponseHelper()
