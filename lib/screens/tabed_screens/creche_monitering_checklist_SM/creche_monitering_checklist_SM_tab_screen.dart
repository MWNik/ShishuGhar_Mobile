...
import 'creche_monitering_checklist_SM_tabitem_screen.dart';
import 'creche_monitering_checklist_SM_tabitem_view_screen.dart';

class CmcSMTabSCreen extends StatefulWidget {
  ...
  @override
  State<CmcSMTabSCreen> createState() => _CmcSMTabSCreenState();
}

class _CmcSMTabSCreenState extends State<CmcSMTabSCreen>
    ...
    for (int i = 0; i < tabBreakItems.length; i++) {
      if (tabBreakItems[i].parent == 'Safety Indicators') {
        tabItem.add(widget.isViewScreen
            ? CmcSMTabItemViewSCreen(
                creche_id: widget.creche_id.toString(),
            smguid: widget.cmc_cc_guid,
