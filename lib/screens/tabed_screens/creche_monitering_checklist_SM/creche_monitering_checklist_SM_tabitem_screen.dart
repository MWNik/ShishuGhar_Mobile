...
class CmcSMTabItemSCreen extends StatefulWidget {
  final String smguid;
  ...
  @override
  State<CmcSMTabItemSCreen> createState() => _CmcSMTabItemSCreenState();
}

class _CmcSMTabItemSCreenState extends State<CmcSMTabItemSCreen> {
