...
class CrecheEnrollChildEnrollScreen extends StatefulWidget {
  final String? creche_id;
  final String? chilenrolledGUID;

  CrecheEnrollChildEnrollScreen({
    super.key,
  ...
  @override
  State<CrecheEnrollChildEnrollScreen> createState() =>
      _CrecheEnrollChildEnrollScreenState();
}

class _CrecheEnrollChildEnrollScreenState
    extends State<CrecheEnrollChildEnrollScreen> {
  ...
  Future<void> fetchChildexits() async {
    ...
    crecheEnrollChild = await CrecheDataHelper()
                                ...
                                MaterialPageRoute(
                                    builder: (BuildContext context) =>
                                        ChildExitDetailsScreen(
                                          ...
                                          enName: Global.stringToInt(crecheEnrollChild[index]['name'].toString()),
