...
class AllcmcALMListingScreen extends StatefulWidget {
  ...
  @override
  State<AllcmcALMListingScreen> createState() => _cmcALMListingScreenState();
}

class _cmcALMListingScreenState extends State<AllcmcALMListingScreen> {
