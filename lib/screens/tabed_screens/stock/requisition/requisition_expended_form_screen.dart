...
class RequisitionExpendedFormScreen extends StatefulWidget {
  final String rguid;
  final int month;
  final int year;
  ...
  @override
  State<RequisitionExpendedFormScreen> createState() =>
      _RequisitionExpendedFormScreenState();
}
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Visibility(
                      visible:
                          type == 0 ? expended == index : expendedNav == index,
                      child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: cWidget(fields, quantity_required,
                              ItemName!, fieldData, type, isReadable)),
                    ),
                  ],
                ),
              ),
