...
class ChildFollowUpCompletedForChildCC extends StatefulWidget {
  ...
  ChildFollowUpCompletedForChildCC({
    super.key,
  ...
  @override
  State<ChildFollowUpCompletedForChildCC> createState() =>
      _ChildFollowUpsListingScreenState();
}

class _ChildFollowUpsListingScreenState
    extends State<ChildFollowUpCompletedForChildCC> {
  bool isLoading = true;
          ...
          children: [
            RichText(
                ...
                text: TextSpan(children: [
                  TextSpan(
                      text: '${widget.childName} ', style: Styles.white145),
                  TextSpan(text: ' - ${widget.childId}', style: Styles.white145)
                ])),
            Text(Global.returnTrLable(translats, CustomText.fllowUp, lng),
