...
class _ChildFollowUpsListingScreenState
  ...
  Future<void> fetchFollowUpList() async {
    followUpsList = await ChildFollowUpTabResponseHelper().callCompletedReffralForChild(widget.childenrollguid);
    setState(() {});
  }
                  ...
                  return GestureDetector(
                    onTap: () async {
                      ...
                      bool isEditable = currentDate.isBefore(DateTime.parse(
                          followUpsList[index].created_at
                              .toString())
                          .add(Duration(days: 7)));
                      var dateString = followUpsList[index].schedule_date!;
                      var parts = dateString.toString()
                        ...
                        var refStatus = await Navigator.of(context)
                            ...
                            builder: (BuildContext context) =>
                               ChildFollowUpTabScreen(
                                  ...
                                  discharge_date: Global.getItemValues(followUpsList[index].responces,'discharge_date'),
                                  followup_visit_date: followUpsList[index].followup_visit_date!,
                                 schedule_date: followUpsList[index].schedule_date!,
                                    ...
                                    children: [
                                      Text(
                                        Validate().displeDateFormate(
                                            followUpsList[index].schedule_date!),
