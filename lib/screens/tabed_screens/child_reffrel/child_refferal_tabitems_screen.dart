    ...
    switch (quesItem.fieldtype) {
      case 'Link':
        ...
        return DynamicCustomDropdownField(
          ...
          readable:
              quesItem.fieldname == 'child_status' ? widget.isDischarge : null,
          items: items,
      ...
      case 'Date':
        return CustomDatepickerDynamic(
          ...
          readable: (quesItem.fieldname == 'date_of_referral' ||
                  ...
                  quesItem.fieldname == 'visit_date' ||
                  quesItem.fieldname == 'admission_date'
              ? widget.isDischarge
              : false),
    ...
    if (items != null) {
      for (int i = 0; i < items.length; i++) {
        ...
        if (Global.validString(validationMsg)) {
          Validate()
              .singleButtonPopup(validationMsg!, Global.returnTrLable(
