...
class SynchronizationScreenNew extends StatefulWidget {
  const SynchronizationScreenNew({super.key});

  @override
  State<SynchronizationScreenNew> createState() =>
      _SynchronizationScreenNewState();
}

class _SynchronizationScreenNewState extends State<SynchronizationScreenNew> {
  List<String> image = [
                    ...
                    itemBuilder: (ctx, i) {
                      return InkWell(
                        onTap: () async {
                          ...
                          // else if (i == 3) {
                          //   try {
                          //     bool shouldProceed = await DoctypeUpdate(
                          //             locationControlls: locationControlls,
                          //             lng: lngtr!,
                          //             role: role,
                          //             mt: mounted)
                          //         .callFieldData(context);
                          //     if (shouldProceed) await initializeData();
                          //   } catch (e) {
