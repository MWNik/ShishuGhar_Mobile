...
class DynamicCustomDropdownForFilterField extends StatefulWidget {
...
class _CustomDropdownFieldState extends State<DynamicCustomDropdownForFilterField> {
            ...
            Container(
              ...
              child: Padding(
                ...
                child: DropdownButtonFormField<OptionsModel>(
                  value:  (widget.selectedItem != null ? (widget.items.where((element) => element.name == widget.selectedItem).length>0)?
