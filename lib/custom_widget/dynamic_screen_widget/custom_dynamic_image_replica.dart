...
class CustomImageDynamicReplica extends StatefulWidget {
  ...
  @override
  _CustomImageDynamicReplicaState createState() => _CustomImageDynamicReplicaState();
}
...
class _CustomImageDynamicReplicaState extends State<CustomImageDynamicReplica> {
      ...
      children: [
        ...
        Column(
          children: [
            GestureDetector(
              onTap: () async {
                if (widget.readable == false && !Global.validString(widget.assetPath)) {
            ...
            Visibility(
              visible: widget.isDelitable == true && image != null?true:false,
  ...
  openDailogBox(BuildContext context,String message,String negButton,String posButton){
      showDialog(
        context: context,
