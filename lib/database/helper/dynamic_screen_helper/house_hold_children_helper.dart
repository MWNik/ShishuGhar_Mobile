...
class HouseHoldChildrenHelperHelper {
  ...
  Future<void> insertUpdate(String hhGuid, String CHHGUID, String responces,
      String userId, int? name, int? parent) async {
  ...
  Future<List<HouseHoldChildrenModel>> getHouseHoldChildren(
    ...
    List<Map<String, dynamic>> result = await DatabaseHelper.database!
        .rawQuery('select * from house_hold_children where HHGUID=?', [hhGuid]);
