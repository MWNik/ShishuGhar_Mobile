...
class ChildEventMetaFieldsModel {
  TabHousehold_Form? tabChild_Event_Meta;

  ChildEventMetaFieldsModel({
    this.tabChild_Event_Meta,
  });

  factory ChildEventMetaFieldsModel.fromJson(Map<String, dynamic> json) =>
      ChildEventMetaFieldsModel(
        tabChild_Event_Meta: TabHousehold_Form.fromJson(json['tabChild Event']),
      );

  Map<String, dynamic> toJson() => {
        "tabChild Event": tabChild_Event_Meta,
      };
}
