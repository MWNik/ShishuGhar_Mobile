class ChildImmunizationResponceModel {
  String? child_immunization_guid;
  ...
  ChildImmunizationResponceModel(
      {this.child_immunization_guid,
  ...
  factory ChildImmunizationResponceModel.fromJson(Map<String, dynamic> json) =>
      ChildImmunizationResponceModel(
        child_immunization_guid: json["child_immunization_guid"],
